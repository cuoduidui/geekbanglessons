...
<body>
	<div class="container">
		<form class="form-signin" action="/user-web/login/register" method="post">
			<h1 class="h3 mb-3 font-weight-normal">注册</h1>
			<label for="inputEmail" class="sr-only">请输入姓名</label>
            <input id="inputEmail" class="form-control" name="name" placeholder="请输入姓名" required autofocus>
            <label for="inputEmail" class="sr-only">请输入手机号</label>
            <input type="phone" id="inputEmail" class="form-control" name="phoneNumber" placeholder="请输入手机号" required autofocus>
